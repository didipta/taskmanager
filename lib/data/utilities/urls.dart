class Urls {
  ...
  static String emailvarification(String id) => '$_baseUrl/RecoverVerifyEmail/$id';
  static String RecoverVerifyOTP(String id,String email) => '$_baseUrl/RecoverVerifyOTP/$email/$id';
